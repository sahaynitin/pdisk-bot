...
async def start(client,message):
	...
	await message.reply_text("Hey I am a Pdisk Uploader Bot",reply_to_message_id = message.message_id,reply_markup=InlineKeyboardMarkup([ [ InlineKeyboardButton("📡 Updates Channel" ,url="https://t.me/tellybots_4u") ], [InlineKeyboardButton("💬 Support Group", url="https://t.me/tellybots_support") ]  ]  ) 
        )
